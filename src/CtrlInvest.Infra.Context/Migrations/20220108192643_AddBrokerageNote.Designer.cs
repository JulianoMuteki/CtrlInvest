...
namespace CtrlInvest.Infra.Context.Migrations
{
    ...
    [Migration("20220108192643_AddBrokerageNote")]
    partial class AddBrokerageNote
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CtrlInvest.Domain.Entities.InvestimentsPortifolios.BrokerageNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("TypeDeal")
                        .HasColumnType("integer")
                        .HasColumnName("TypeDeal");

                    b.Property<int>("TypeMarket")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CtrlInvest.Domain.Entities.InvestimentsPortifolios.BrokerageNote", b =>
                {
                    b.HasOne("CtrlInvest.Domain.Entities.Bank", "FinancialInstitution")
                        .WithMany("BrokerageNotes")
