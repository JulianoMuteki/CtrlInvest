...
namespace CtrlInvest.Import.HistoricalPrice
{
    public class Worker2 : BackgroundService
    {
        ...
        public Worker2(IServiceProvider services, ILogger<Worker> logger, IImportHistoricalPriceService historicalPriceImportController, IMessageBrokerService messageBrokerService)
        {
            _logger = logger;
